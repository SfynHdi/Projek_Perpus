      ...
      <div class="live-stream">
          ...
          <div class="row">
              <div class="col-lg-3 col-sm-6">
                  <div class="item">
                      <div class="thumb">
                          <img src="assets/frontend/images/stream-05.jpg" alt="">
                      ...
                      <div class="down-content">
                          <div class="avatar">
                              <img src="assets/frontend/images/avatar-01.jpg" alt="" style="max-width: 46px; border-radius: 50%; float: left;">
                          </div>
              ...
              <div class="col-lg-3 col-sm-6">
                  <div class="item">
                      <div class="thumb">
                          <img src="assets/frontend/images/stream-06.jpg" alt="">
                          <div class="hover-effect">
                              <div class="content">
                                  <div class="live">
                                      <a href="#">Live</a>
                      ...
                      <div class="down-content">
                          <div class="avatar">
                              <img src="assets/frontend/images/avatar-02.jpg" alt="" style="max-width: 46px; border-radius: 50%; float: left;">
                          </div>
              ...
              <div class="col-lg-3 col-sm-6">
                  <div class="item">
                      <div class="thumb">
                          <img src="assets/frontend/images/stream-07.jpg" alt="">
                          <div class="hover-effect">
                              <div class="content">
                                  <div class="live">
                                      <a href="#">Live</a>
                      ...
                      <div class="down-content">
                          <div class="avatar">
                              <img src="assets/frontend/images/avatar-03.jpg" alt="" style="max-width: 46px; border-radius: 50%; float: left;">
                          </div>
              ...
              <div class="col-lg-3 col-sm-6">
                  <div class="item">
                      <div class="thumb">
                          <img src="assets/frontend/images/stream-08.jpg" alt="">
                          <div class="hover-effect">
                              <div class="content">
                                  <div class="live">
                                      <a href="#">Live</a>
                      ...
                      <div class="down-content">
                          <div class="avatar">
                              <img src="assets/frontend/images/avatar-04.jpg" alt="" style="max-width: 46px; border-radius: 50%; float: left;">
                          </div>
